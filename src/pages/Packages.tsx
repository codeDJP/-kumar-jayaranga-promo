...
const Packages = () => (
  <div className="container py-20">
    ...
    <div className="mt-8 flex flex-wrap gap-4">
      <DownloadButton href="/docs/price-list.pdf" label="Download Price List" version="1.0" lastUpdated="Feb 2026" />
      <DownloadButton href="/docs/terms-and-conditions.pdf" label="Download T&C" version="1.0" lastUpdated="Feb 2026" />
    </div>
  </div>
);
